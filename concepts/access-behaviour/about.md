...
To use the behaviour, you may follow a bound variable with _square brackets_ and then use the key to retrieve the value associated with that key. Maps do not impose any restriction on the key type, while keyword lists only atom keys.
